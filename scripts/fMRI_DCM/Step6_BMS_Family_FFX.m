...
cwd = pwd;
base = 'C:/Users/jschraeder/Desktop/emocon/';
data = fullfile(base,'FirstLevel/BackwardMask/');      


% HC excluded participants: sub-005,sub-013, sub-016, sub-058, sub-063,
% sub-101, sub-105 (movement), sub-078 (checked 25.09.2023) 05.04.24
% ->,'sub-017',,'sub-045','sub-054','sub-088','sub-127'
HC_Subjects = {'sub-004','sub-006','sub-010','sub-011','sub-014','sub-015','sub-018','sub-019','sub-021','sub-022','sub-024','sub-025'...
...
%test
%HC_Subjects = {'sub-004','sub-006'};
%MDD_Subjects = {'sub-007','sub-008'};
...
for i = 1:numel(HC_Subjects)    
    ...
    j = 1;
        	for k = 1:24 %number of models
                ...
                = sprintf('C:/Users/jschraeder/Desktop/emocon/FirstLevel/BackwardMask/%s/DCM_model_%02d_of_24.mat', subName, k);
            end
