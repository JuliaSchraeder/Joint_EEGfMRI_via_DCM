...
function [names, onsets, durations] = Step3_firstlevel_mkConFile_BackwardMask_from_sub_17(subName)
...
Primer_Onset_row = str2double(data{1,45});                                  % get times in seconds of primer onset
...
Fixcross_Onset_row = str2double(data{1,41});                                % get onset of fixcross
